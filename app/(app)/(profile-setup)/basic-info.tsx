...
export default function BasicInfo() {
  ...
  const onSubmit = (data: ProfileFormData) => {
    ...
    // router.push("/(app)/(profile-setup)/next-step");
  };
  ...
  return (
    <ScrollView 
      style={{ flex: 1, backgroundColor: 'white' }} // Main style
      contentContainerStyle={{ flexGrow: 1 }} // Ensures content fills the height
    >
    <Box className="bg-white p-6 w-full h-full pt-16">
      ...
      <VStack space="sm" className="mt-auto pb-6">
        <Button
          ...
          onPress={() => router.push("/(app)/(profile-setup)/set-pin")}
        >
